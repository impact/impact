...
\begin{description}
  ...
  \item[3] \code{B:1.2.0} uses \code{C:1.2.0}
  \item[4] \code{A:1.0.0} uses \code{B:1.1.0} or \code{B:1.0.0} (\emph{i.e.,} \code{A}
...
\begin{description}
  \item[\code{A:2.0.0}] no conflicts
  \item[\code{A:2.0.0} \& \code{B:1.2.0}] no conflicts
  \item[\code{A:2.0.0} \& \code{B:1.2.0} \& \code{C:1.2.0}] violates \#2
  \item[\code{A:2.0.0} \& \code{B:1.2.0} \& \code{C:1.1.0}] violates \#3
  \item[\code{A:2.0.0} \& \code{B:1.1.0}] violates \#1
  \item[\code{A:2.0.0} \& \code{B:1.0.0}] violates \#1
  \item[\code{A:1.0.0} \& \code{B:1.2.0}] violates \#4
i  \item[\code{A:1.0.0} \& \code{B:1.1.0}] no conflicts
  \item[\code{A:1.0.0} \& \code{B:1.1.0} \& \code{D:1.1.0}] no conflicts
  \item[\code{A:1.0.0} \& \code{B:1.1.0} \& \code{D:1.1.0} \& \code{C:1.2.0}] violates \#7
  \item[\code{A:1.0.0} \& \code{B:1.1.0} \& \code{D:1.1.0} \& \code{C:1.1.0}] violates \#8
  \item[\code{A:1.0.0} \& \code{B:1.1.0} \& \code{D:1.0.0}] violates \#5
  \item[\code{A:1.0.0} \& \code{B:1.0.0} \& \code{D:1.1.0} \& \code{C:1.2.0}] violates \#6
  \item[\code{A:1.0.0} \& \code{B:1.0.0} \& \code{D:1.1.0} \& \code{C:1.1.0}] \textbf{solution}
\end{description}
...
% TODO: Insert graphic (see images directory)...should probably redo
% with yEd
