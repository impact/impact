...
\hypersetup{
  ...
  pdfauthor = {Michael Tiller and Dietmar Winkler and Christoph H\"oger},
...
\affil[3]{\href{http://www.tu-berlin.de}{Technische Universit\"at Berlin}, Germany, {\small\href{mailto:christoph.hoeger@tu-berlin.de}{\nolinkurl{christoph.hoeger@tu-berlin.de}}}}
...
%% TODO: Cite Modelica proposal mentioned below
...
versions of \code{B} that are compatible\footnote{It is not possible
  ...
  Modelica \cite{https://trac.modelica.org/Modelica/raw-attachment/ticket/573/Package-Proposal_asMCP.doc} and/or to support cases we will discuss shortly
...
%% TODO: Cite Go languages

We've created an implementation of \code{impact} using Go\cite{http://golang.org/ref/spec}.
...
extensions\cite{https://github.com/GeertJohan/go.rice}
\cite{https://bitbucket.org/tebeka/nrsc/}
