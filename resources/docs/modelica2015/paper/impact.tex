...
\begin{description}
  ...
  \item[{\code A:2.0.0} & {\code B:1.2.0} & {\code C:1.0.0}] violates #3
  \item[{\code A:2.0.0} & {\code B:1.2.0} & {\code C:1.1.0}] violates #2
  ...
  \item[{\code A:1.0.0} & {\code B:1.1.0}] no conflicts
  ...
  \item[{\code A:1.0.0} & {\code B:1.1.0} & {\code D:1.1.0} & {\code C:1.1.0}] violates #9
\end{description}
