...
\begin{tabular}{ l l l }
   \code{A:2.0.0} &\cmark\\
   \code{A:2.0.0} \& \code{B:1.2.0} & \cmark\\
   ...
   \code{A:1.0.0} \& \code{B:1.1.0} &\cmark\\
   \code{A:1.0.0} \& \code{B:1.1.0} \& \code{D:1.1.0}& \cmark\\
  ...
  \code{A:1.0.0} \& \code{B:1.0.0} \& \code{D:1.1.0} \& \code{C:1.1.0} &\cmark\cmark
\end{tabular}
\end{center}
}
