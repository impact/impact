...
\code{maven}.  For Python, tools like \code{easy\_install} and
\code{pip} are used for managing packages.  For client-side web
development, \code{bower} is used.  For server-side JavaScript, the
tool of choice is \code{npm}.  For compiled languages, these package
...
\href{https://github.com}{GitHub} in our case, for providing a means
...
doesn't solve some of the problems currently inherent in Modelica.  At
...
is hosted on GitHub at \code{https://github.com/xogeny/impact}.
